...
| **Competitor Insight** | Compare 2-3 channels' growth trends, view distributions, and engagement metrics with AI-generated competitive landscape analysis |
| **Channel Management** | Track and analyze YouTube channels you follow |
| **Video Board** | Kanban-style video project management + AI content strategy suggestions |
| **AI Parameter Self-Iteration** | Automatic radar parameter retrospective, persistence, and backfill — forming an optimization loop |
...
- **Scheduler**: APScheduler (channel sync + radar auto-retrospective)
