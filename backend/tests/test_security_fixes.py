...
class TestDockerComposeSecurity:
    ...
    _KNOWN_LEAKED_SECRETS: list[tuple[str, str]] = [
        ("kFIWF6PMiOJYlQBKGUHuNZ2hGHvzq96CjKjYHg4M4YkqiUHENsS_LGZRBWAgp4R0", "JWT SECRET_KEY"),
        ("WC2Asvn5Pd6MDDqH", "SMTP_PASSWORD"),
        ("whataicompass", "SMTP_USER"),
        ("whataicompass@126.com", "SMTP_FROM_EMAIL"),
        ("compass.whatai.me", "FRONTEND_BASE_URL domain"),
        ("creator123", "MYSQL_PASSWORD"),
        ("smtp.126.com", "SMTP_HOST"),
    ]
