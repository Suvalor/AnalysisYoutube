...
from app.api.v1 import channel_growth
...
api_router_v1.include_router(channels.router, prefix="/channels", tags=["channels"])
api_router_v1.include_router(channel_growth.router, prefix="/channel-growth", tags=["channel-growth"])
api_router_v1.include_router(radar.router, prefix="/radar", tags=["radar"])
api_router_v1.include_router(keyword.router, prefix="/keyword", tags=["keyword"])
api_router_v1.include_router(seo.router, prefix="/seo", tags=["seo"])
