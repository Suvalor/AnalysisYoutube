...
DEFAULT_QUOTAS: dict[str, dict[str, int]] = {
    UserRole.GUEST: {"youtube_api": 1, "llm_api": 1, "cv_api": 1},
    UserRole.USER: {"youtube_api": 1, "llm_api": 3, "cv_api": 3},
    UserRole.SUBSCRIBER: {"youtube_api": 10, "llm_api": 20, "cv_api": 10},
    UserRole.ADMIN: {"youtube_api": 1000, "llm_api": 1000, "cv_api": 500},
}
