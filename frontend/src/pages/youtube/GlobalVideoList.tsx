import { Button, DatePicker, Input, InputNumber, Modal, Pagination, Select, Tag, message } from "antd";
        ...
        {loading ? (
          ...
          videos.map((video) => (
            <div key={video.id} className="bg-white border border-slate-200 rounded-lg p-3 shadow-sm flex flex-col md:flex-row gap-4">
              ...
              <div className="flex flex-row md:flex-col gap-3 md:w-52 shrink-0 items-end md:items-stretch justify-between">
                <div className="border border-slate-200 rounded-md p-2 text-sm space-y-1 w-full">
