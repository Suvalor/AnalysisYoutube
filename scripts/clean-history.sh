...
REPLACEMENTS=(
    ...
    "literal:REDACTED_SECRET_KEY==>REDACTED_SECRET_KEY"
    "literal:REDACTED_SMTP_PASSWORD==>REDACTED_SMTP_PASSWORD"
    "literal:REDACTED_SMTP_EMAIL==>REDACTED_SMTP_EMAIL"
    "literal:REDACTED_SMTP_USER==>REDACTED_SMTP_USER"
    "literal:REDACTED_DOMAIN==>REDACTED_DOMAIN"
    "literal:REDACTED_MYSQL_PASSWORD==>REDACTED_MYSQL_PASSWORD"
)
