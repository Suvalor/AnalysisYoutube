...
| docker-compose.yml | SMTP 密码 (WC2Asvn5Pd6MDDqH) | **严重** |
| docker-compose.yml | SMTP 用户名 (whataicompass) + 邮箱 | 高 |
| docker-compose.yml | 生产域名 (compass.whatai.me) | 高 |
| docker-compose.yml | MySQL root/application 密码 | 中 |
| docker-compose.yml | SMTP 服务商 (smtp.126.com) | 低 |
